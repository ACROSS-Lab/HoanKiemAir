...
main_folder <- "~/Dev/GitRepository/HoanKiemAir/Analysis_results_COSMOS/exp4"
size_of_csv <- 1500
...
p_mean <- create_dygraphs(df_mean,main_folder,500,nameY)
p_mean
...
p_stddev <- create_dygraphs(df_stddev,main_folder,250,nameY)
p_stddev
