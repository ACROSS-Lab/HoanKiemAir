...
main_folder <- "~/Dev/GitRepository/HoanKiemAir/Analysis_results_COSMOS/exp5"
size_of_csv <- 3000
...
p_mean <- create_dygraphs(df_mean,main_folder,250,nameY)
p_mean
...
p_stddev <- create_dygraphs(df_stddev,main_folder,70,nameY)
p_stddev
...
p_meanMin <- create_dygraphs(df_meanMin,main_folder,18,nameY)
p_meanMin
